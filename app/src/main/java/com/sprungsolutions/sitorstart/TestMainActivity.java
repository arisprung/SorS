...
import com.sprungsolutions.sitorstart.player_list.MainActivity;
import com.sprungsolutions.sitorstart.util.IabBroadcastReceiver;
import com.sprungsolutions.sitorstart.util.IabHelper;
import com.sprungsolutions.sitorstart.util.IabResult;
import com.sprungsolutions.sitorstart.util.Inventory;
import com.sprungsolutions.sitorstart.util.Purchase;
 ...
 */
public class TestMainActivity extends Activity implements IabBroadcastReceiver.IabBroadcastListener,
        OnClickListener {
    ...
    static final String SKU_PREMIUM = "test_product";
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         */
        String base64EncodedPublicKey = getString(R.string.in_app_billing);
        ...
        mHelper.startSetup(new IabHelper.OnIabSetupFinishedListener() {
            public void onIabSetupFinished(IabResult result) {
                ...
                mBroadcastReceiver = new IabBroadcastReceiver(TestMainActivity.this);
